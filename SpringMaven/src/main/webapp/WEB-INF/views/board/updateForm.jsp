...
<div align="center">
    <b>글수정</b><br/><br/>
    <form name="f" action="board_update.do" method="post" onsubmit="return checkBoard()">
        ...
        <table border="1" width="800px">
            ...
            <tr>
                ...
                <td><input type="text" name="email"  value="${getBoard.email}"></td>
            </tr>
            <tr>
                <th width="20%" bgcolor="yellow">내 용</th>
                <td>
                    <label>
                        <textarea name="content" rows="8" cols="50">${getBoard.content}</textarea>
                    </label>
                </td>
            </tr>
            <tr>
